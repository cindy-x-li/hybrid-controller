% =========================================================================
% PLOT SLOW PI-CONTROLLER (With Metrics)
...
plot(time_steps, H_history, 'b', 'LineWidth', 1.5, 'DisplayName', 'PI Controller');
...
plot(time_steps, H_history, 'b', 'LineWidth', 1.5);
...
plot(time_steps, u_history, 'b-', 'LineWidth', 1.5, 'DisplayName', 'Pump Voltage');
